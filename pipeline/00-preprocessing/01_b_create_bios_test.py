...
PROFILER_LLM = LLM(api_key=ENV["HF_TOKEN"], model="Qwen/Qwen3-235B-A22B-Instruct-2507:cerebras")

with open("../../prompts/profiler.txt", "r") as f:
    PROFILER_PROMPT = f.read()


german_comments = json.load(open("../../data/intermediate/ger_30-shot_test.json", "r", encoding="utf-8"))
english_comments = json.load(open("../../data/intermediate/eng_30-shot_test.json", "r", encoding="utf-8"))
luxembourgish_comments = json.load(open("../../data/intermediate/lux_30-shot_test.json", "r", encoding="utf-8"))

random.seed(42)

german_comments = random.sample(german_comments, 650)
...
for comment in tqdm.tqdm(english_comments):
    ...
    json.dump(english_comments, open("../../data/intermediate/eng_30-shot_test_with_bios.json", "w", encoding="utf-8"))