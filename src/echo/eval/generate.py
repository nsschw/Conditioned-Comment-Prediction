...
def generate(model_path: str, model_name: str, output_path: str, test_data_path: str, batch_size: int = 3, **kwargs):
    ...
    run = {"generation_args": kwargs, "generations": preds, "model_name": model_name, "model_path": model_path, "test_data_path": test_data_path}
